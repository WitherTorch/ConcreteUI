...
{
    internal sealed class SubtractOperatorLayoutVariable : LayoutVariable
    {
        private readonly LayoutVariable _leftVariable, _rightVariable;

        public SubtractOperatorLayoutVariable(LayoutVariable left, LayoutVariable right)
        {
            _leftVariable = left;
        ...
        public override bool Equals(object? obj) => obj is SubtractOperatorLayoutVariable another &&
