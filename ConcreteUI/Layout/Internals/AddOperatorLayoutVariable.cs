...
{
    internal sealed class AddOperatorLayoutVariable : LayoutVariable
    {
        private readonly LayoutVariable _leftVariable, _rightVariable;

        public AddOperatorLayoutVariable(LayoutVariable left, LayoutVariable right)
        {
            _leftVariable = left;
        ...
        public override bool Equals(object? obj) => obj is AddOperatorLayoutVariable another &&
