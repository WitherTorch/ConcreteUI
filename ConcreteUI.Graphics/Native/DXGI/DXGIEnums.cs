...
namespace ConcreteUI.Graphics.Native.DXGI
{
    ...
    public enum DXGIUsage : uint
    {
        None = 0,
        BackBuffer = 1U << 2 + 4,
        DiscardOnPresent = 1U << 5 + 4,
        ReadOnly = 1U << 4 + 4,
        RenderTargetOutput = 1U << 1 + 4,
        ShaderInput = 1U << 0 + 4,
        Shared = 1U << 3 + 4,
        UnorderedAccess = 1U << 6 + 4
    }
    ...
    [Flags]
    public enum DXGIAdapterFlags : uint
    {
        None = 0,
        Remote = 1,
        Software = 2
    ...
    [Flags]
    public enum DXGIMakeWindowAssociationFlags : uint
    {
        /// <summary>
        /// Prevent DXGI from monitoring an applications message queue. <br/>
    ...
    public enum DXGIFeature : uint
    {
        PresentAllowTearing = 0
    }

    [Flags]
    public enum DXGIMapFlags : uint
    {
        /// <summary>
