...
namespace ConcreteUI.Graphics.Native.Direct2D
{
    ...
    public unsafe sealed class D2D1Bitmap1 : D2D1Bitmap
    {
        ...
        private D2D1BitmapOptions GetOptions()
        {
            ...
            return ((delegate*<void*, D2D1BitmapOptions>)functionPointer)(nativePointer);
        }
        ...
        public D2D1MappedRect Map(D2D1MapOptions options)
        {
            ...
            int hr = ((delegate*<void*, D2D1MapOptions, D2D1MappedRect*, int>)functionPointer)(nativePointer, options, &mappedRect);
            if (hr >= 0)
                return mappedRect;
            throw Marshal.GetExceptionForHR(hr);
        }
